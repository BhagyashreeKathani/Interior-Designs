		...
		<div className="w-full lg:px-[150px] px-5 lg:py-10 py-8 flex flex-col items-center justify-center gap-5">
			<div className="flex flex-col items-center">
				...
				<p className="mt-3 text-gray-500 text-center max-w-[500px]">
					Discover a curated selection of modern, luxury, and eco-friendly interior designs.
					Each layout is thoughtfully crafted to reflect elegance, functionality, and timeless beauty.
				</p>
			</div>
